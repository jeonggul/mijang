/*
 * StockDividendSyncScheduler — 배당 수집·예상 생성·알림 배치
 *
 * 이 파일이 하는 일
 *   매일 아침 보유 종목의 배당 이벤트를 받아 오고, 이어서 배당락일이 지난
 *   이벤트로 예상 배당(PROFIT-12)을 만든 뒤 사용자 알림(NOTI-04)을 생성한다.
 *   실행 여부는 배치 상태 화면에 남는다.
 */
...
/**
 * 배당 수집·예상 생성·알림 배치. PROFIT-12 · INFO-06 · NOTI-04
 *
 * <p>08:00 KST — 일봉 수집(07:00)·가격 알림 생성(07:30) 뒤다. 배당 공시는 거래일과
 * 무관하게 나오므로 휴장일을 거르지 않고 매일 돈다.
 *
 * <p>수집·예상·알림을 한 로그로 묶으면 어느 단계가 실패했는지 알 수 없어 각각 기록한다.
 */
@Component
